<template>
  <div ref="container">
    <div
      ...
      <i :class="{ 'full-btn': true, 'full-active': fullState===1 }" title="全屏" style="float: right;margin-right: 20px"
         @click="handleFullScreen"></i>
      <i :class="{'key-btn-v': directionState===0, 'key-btn-h': directionState===1}" title="横竖屏"
         style="float: right;margin-right: 20px" @click="handleDirectionChange"></i>
      <i :class="{'page-btn-1': pagePerState===1, 'page-btn-2': pagePerState===2,'page-btn-3': pagePerState===3}"
         title="切换横屏页数" style="float: right;margin-right: 20px" @click="handlePagePerChange"></i>
      <i
